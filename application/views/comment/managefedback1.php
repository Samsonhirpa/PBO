      ...
      <div class="box-body">
            <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                  ...
                  <tbody>
                        <?php
                        $no = 0;
                              foreach ($this->str->getfedback1($this->session->userdata('username')) as $row ) {
                              $no++;
                              ?>
                              <tr role="row" class="odd">
                                    ...
                                    <td>
                                          <a class="btn btn-sm btn-danger" href="<?php echo base_url('Structure/Delete_fedback1/' . $row->id) ?>"onclick="return confirm('Are you sure To Delete ?')">Delete</a>
                        ...
                        <div class="modal fade" id="modal-default<?php echo $row->id; ?>">
                              <form role="form" action="<?php echo base_url('Structure/Edit_fedback1/'.$row->id); ?>" method="post">
