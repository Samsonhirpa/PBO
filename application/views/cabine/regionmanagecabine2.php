...
<div class="container-fluid">
      <h3 class="box-title"><i class="fa fa-plus-square"> Hoggantootaa Godinaa To'achuu</i></h3>
...
foreach ($this->str->getregioncabineprofile2($this->session->userdata('zone')) as $row ) {
                        $no++;
                        ?>
