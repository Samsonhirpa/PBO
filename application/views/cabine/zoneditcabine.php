<div class="content-wrapper">
      <section class="content" style="min-height: 526px;">
            <div class="col-xs-12">
                  <div class="col-lg-12 col-sm-12 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-hand-pointer-o"></i>Hoggaanaa Haaraa Galmeessi </h3></div>
            </div>
...
<form role="form" action="<?php echo base_url('Structure/updatezonecabine/' .$cabine->cab_id); ?>" method="Post" enctype="multipart/form-data">
...
<div class="box-header with-border">
            ...
            <div class="row">
                  <div class="col col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $cabine->maqa;?>" name="maqa" id="company" placeholder="--Maqaa Guutuu galchii--" class="form-control">
                                        </div>
      ...
      <option value="<?php echo $cabine->sala_id;?>"><?php echo $cabine->gender_name;?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="umuri" value="<?php echo $cabine->umuri;?>" id="street" placeholder="Enter Age" class="form-control">
                                        </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select  class="form-control" value="<?php echo $cabine->dhalotaG_id;?>" name="dhalotaG_id" id="zone" >
                                                             <option value=""><?php echo $cabine->zname;?></option>
                                                            <?php
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Aanaa</label>
                         <select class="form-control" value="<?php echo $cabine->dhalotaA_id;?>" name="dhalotaA_id" id="woreda" >
 <option value=""><?php echo $cabine->woreda_name;?></option>
                                                      </select>
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                                            ...
                                            <input type="file" value="<?php echo $cabine->file_name;?>" name="attachment" class="form-control-file">
                                        </div>
                  ...
                  <div class="col col-md-6">
                                            ...
                                            <input type="text" value="<?php echo $cabine->bilbila;?>" name="bilbila" id="company" placeholder="Enter phone Number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label"><h4>Imeeli</h4></label>
                                            <input type="text" value="<?php echo $cabine->email;?>" name="email" id="vat" placeholder="Enter Email" class="form-control">
                                        </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Baayyina Dhiiraa</label>
                         <input type="text" value="<?php echo $cabine->bayinaM;?>" name="bayinaM" id="company" placeholder="Enter phone Number" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Baayyina Dhalaa</label>
                          <input type="text" value="<?php echo $cabine->bayinaF;?>" name="bayinaF" id="company" placeholder="Enter phone Number" class="form-control">
                      </div>
                    </div>
                  </div>
