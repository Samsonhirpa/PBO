...
<div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="<?php echo base_url('Structure/addcabines2') ?>" class="btn btn-primary"><i class="fa fa-plus-square">Dabalii Galmeessi </i></a></h3>
          </div>
          <div class="box-body">
 ...
 -->
                 ...
                 <tbody>
                  ...
                  $no = 0;
                        ...
                        foreach ($this->str->getcabineprofile2($this->session->userdata('username')) as $row ) {
                        $no++;
                        ?>
                      ...
                      <td>
                                     ...
                                     <a class="btn btn-xs alert-success" href="<?php echo base_url('structure/requst_status/'.$row->c_id)?>"onclick="return confirm('Are you sure To Approve This Request ??')"><i <?php if($row->requst_status == 0 ) { ?> class="fa fa-cloud-upload"> Applied </i> <i <?php } if($row->requst_status == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->requst_status == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>Approved</i> </a>

                      </td> 
                             <td>
                    <a class="btn btn-sm btn-info"href="<?php echo base_url('Structure/editcabine2/'.$row->c_id)?>"><i class="fa fa-wrench"></i></a>
