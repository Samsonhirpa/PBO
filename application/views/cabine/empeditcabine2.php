...
<div class="callout callout-info">
          <h4>Odeeffannoo Hojii waliin walqabate!</h4>
          
        </div>

<div class="box-header with-border">
 <!--  <div class="box-header with-border" style="background-color: gray">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Qaama carraa barumsaa laateef</label>
                         <input type="text" value="<?php echo $cabine2->carrabarumsa;?>" name="carrabarumsa" id="company" placeholder="--Qaama carraa barumsaa laateef galchii--" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Muuxannoo</label>
                          <input type="text" value="<?php echo $cabine2->muxannoo;?>" name="muxannoo" id="company" placeholder="--Muuxannoo galchii--" class="form-control">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Sadarkaa Barnoota</label>
                         <input type="text" value="<?php echo $cabine2->sadarkaB;?>" name="sadarkaB" id="company" placeholder="--Sadarkaa Barnoota galchii--" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Gosa Barnoota</label>
                          <input type="text" name="gosaB" value="<?php echo $cabine2->gosaB;?>" id="company" placeholder="--Gosa Barnoota galchii--" class="form-control">
                      </div>
                    </div>
    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Yuuniversiti irraa Ebbifamee</label>
                         ...
                         <option style="text-align: center;" value="">--  <?php echo $cabine2->u_name;?> --</option>
...
<label for="street" class=" form-control-label"><h4>Itti gaafatamummarra ka’ee yoo jiraate</h4></label>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Bara</label>
                         <input type="text" value="<?php echo $cabine2->barakafama;?>" name="barakafama" id="company" placeholder="--Bara ka’e galchii--" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Dhimmi ittiin ka’e</label>
                          <input type="text" value="<?php echo $cabine2->dhimakahef;?>" name="dhimakahef" id="company" placeholder="--Dhimmi ittiin ka’e galchii--" class="form-control">
                      </div>
                    </div>
                  </div>
                                        </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Bara Qabsoo</label>
                          <input type="text" value="<?php echo $cabine2->baraqabso;?>" name="baraqabso" id="company" placeholder="--Bara qabsoo galchii--" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Cimina ijoo</label>
                         <input type="text" value="<?php echo $cabine2->ciminaijo;?>" name="ciminaijo" id="company" placeholder="--Cimina ijoo galchii--" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Hanqina ijoo</label>
                          <input type="text" value="<?php echo $cabine2->hanqinaijo;?>" name="hanqinaijo" id="company" placeholder="--Hanqina ijoo galchii--" class="form-control">
                      </div>
                    </div>
                  </div>
                                        </div>
...
<label for="street" class=" form-control-label"><h4>Turtii isaa keessati hojii gaarii hojjeteef Badhaasa argate yoo jiraate</h4></label>
      ...
      <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>Bara</label>
                         <input type="text" value="<?php echo $cabine2->barabadhasa;?>" name="barabadhasa" id="company" placeholder="-- Bara Galchii--" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Hoji itti badhaafame</label>
                          <input type="text" name="hojibadhasa" value="<?php echo $cabine2->hojibadhasa;?>" id="company" placeholder="--Hoji itti badhaafame--" class="form-control">
                      </div>
                    </div><div class="col-sm-4">
                      <div class="form-group">
                        <label>Qaama badhaasicha kenneef</label>
                          <input type="text" value="<?php echo $cabine2->qamabadhase;?>" name="qamabadhase" id="company" placeholder="--Qaama badhaasicha kenneef galchii--" class="form-control">
                      </div>
                    </div>
                  </div>
