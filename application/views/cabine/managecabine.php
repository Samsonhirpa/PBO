...
<div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="<?php echo base_url('Structure/addcabines') ?>" class="btn btn-primary"><i class="fa fa-plus-square">Dabalii Galmeessi </i></a></h3>
          </div>
          <div class="box-body">
...
<div class="box-body">
 ...
 -->
                 ...
                 <tbody>
                  <?php
                  $no = 0;
                  foreach ($this->str->getcabineprofile() as $row ) {
                        $no++;
                        ?>
                        <tr role="row" class="odd">
                             ...
                             <td>
                    <a class="btn btn-sm btn-info"href="<?php echo base_url('Structure/editcabine/'.$row->cab_id)?>"><i class="fa fa-wrench">edit</i></a>
