...
<div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="<?php echo base_url('Structure/zoneaddcabines2') ?>" class="btn btn-primary"><i class="fa fa-plus-square">Odeeffannoo Haaraa Dabalii  </i></a></h3>
          </div>
          <div class="box-body">
