      ...
      <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
                  <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 35.733px;" aria-label="CSS grade: activate to sort column ascending">Director</th> </tr>
            </thead>
            <tbody>
                  <?php
                  $no = 0;
                  foreach ($this->str->getuserrequest1() as $row ) {
                        ...
                        <tr role="row" class="odd">
                             ...
                             <i class="fa fa-tasks"> Comment</i>
                                    </a>
                                    <a class="btn btn-xs alert-success" href="<?php echo base_url('structure/requst_status/'.$row->id)?>"onclick="return confirm('Are you sure To Approve This Request ??')"><i <?php if($row->requst_status == 0 ) { ?> class="fa fa-cloud-upload"> Applied </i> <i <?php } if($row->requst_status == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->requst_status == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>Approved</i> </a>
