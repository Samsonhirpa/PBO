<div class="content-wrapper">
   ...
   <!--   <button type="button"  data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-plus-square btn btn-primary">Add new Request</i>
      </button> -->
            ...
            <thead>
                  <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 170.733px;" aria-label="Browser: activate to sort column ascending">Opretor</th>
                         <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 35.733px;" aria-label="Browser: activate to sort column ascending">download</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 170.417px;" aria-label="CSS grade: activate to sort column ascending">Director</th> <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 170.417px;" aria-label="CSS grade: activate to sort column ascending">Team Leader</th> </tr>
            </thead>
                  ...
                  foreach ($this->str->getuserrequest1() as $row ) {
                        ...
                        <tr role="row" class="odd">
                              ...
                              <td>
                                 <a href="<?php echo base_url('Structure/download/'.$row->id)?>" class="btn btn-xs btn-primary">download<i class="fa fa-download"></i></a></td>
                                 <td>
                                    <a class="btn btn-xs alert-success"  ><i <?php if($row->requst_status == 0 ) { ?> class="fa fa-cloud-upload"> Applied </i> <i <?php } if($row->requst_status == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->requst_status == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>Approved</i> </a>
                                      ...
                                      <a class="btn btn-xs alert-success"  data-toggle="modal" data-target="#modal-defaultedit<?php echo $row->id ?>">
                            <i class="fa fa-tasks">read</i>
                                    </a>
                  
                              </td>
                                <td>
                                    <a class="btn btn-xs alert-success" href="<?php echo base_url('structure/requst_status1/'.$row->id)?>"onclick="return confirm('Are you sure To Approve This Request ??')"><i <?php if($row->requst_status1 == 0 ) { ?> class="fa fa-cloud-upload"> Applied </i> <i <?php } if($row->requst_status1 == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->requst_status1 == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>Approved</i> </a>
                        ...
                        <div class="modal-dialog">
                              <div class="modal-content">
                                    <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                          <h4 class="modal-title">Director comment</h4>
                                    </div>
                                    <div class="modal-body">

                                          <form role="form" action="<?php echo base_url('Structure/Edit_requestcomment/'.$row->id); ?>" method="post">
                                                <div class="box-body">

                                                     <div class="row">
                                                     
                                                    
                                                     <textarea name="directorcom" class="col col-md-12"><?php echo $row->directorcom?></textarea> 
