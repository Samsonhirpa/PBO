            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('Structure/File_uploadzone') ?>" method="Post" enctype="multipart/form-data">
                                    <div class="box-body">
      ...
      <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
                  <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 180.733px;" aria-label="Browser: activate to sort column ascending">Description</th>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 180.733px;" aria-label="Browser: activate to sort column ascending">Opretor</th>
                         <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 125.733px;" aria-label="Browser: activate to sort column ascending">Action</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 125.417px;" aria-label="CSS grade: activate to sort column ascending">ZoneAdmin</th> </tr>
            </thead>
            <tbody>
                  <?php
                  $no = 0;

                  foreach ($this->str->getuserrequest3() as $row ) {
                        $no++;
                        ?>
                        <tr role="row" class="odd">
                              ...
                              <td>
                                  <a href="<?php echo base_url('Structure/download/'.$row->id)?>" class="btn btn-xs btn-primary"><i class="fa fa-download"></i></a>
                                    ...
                                    <a class="btn btn-xs btn-danger" href="<?php echo base_url('Structure/Deleterequestzone/' . $row->id) ?>"onclick="return confirm('Are you sure To Delete this info ??')"><i class="fa fa-trash"></i></a>
                                 </td>
                                 <td>
                                    <a class="btn btn-xs btn-warning" href="<?php echo base_url('structure/requst_status3/'.$row->id)?>"onclick="return confirm('Are you sure To Approve This Request ??')"><i <?php if($row->requst_status3 == 0 ) { ?> class="fa fa-cloud-upload"> Applied </i> <i <?php } if($row->requst_status3 == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->requst_status3 == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>Approved</i> </a>
                        ...
                        <div class="modal-dialog">
                              <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                          <form role="form" action="<?php echo base_url('Structure/Edit_requestzone/'.$row->id); ?>" method="Post" enctype="multipart/form-data">
                                                <div class="box-body">
