<div class="content-wrapper">
      ...
      <div class="box-header">
            <h3 class="box-title"><b>IP Terminate Request Letter from OSTICA to Ethio-telecom </b></h3>
      </div>
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Add Terminate Letter  ATSTQO - telecom Form</h4>
                        </div>
                        <div class="modal-body">
                              <form role="form" action="<?php echo base_url('Structure/save_terminateletter'); ?>" method="post">
                                    <div class="box-body">
                                          ...
                                          <div class="row">
                                                <div class="col col-md-12">
                                                      ...
                                                      <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="-- Enter service Number --" name="service_no" class="form-control">
                                                      </div>
      ...
      <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
                  <tr role="row">
                        ...
                        <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100.95px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Service Number</th>
            ...
            <tbody>
                  ...
                  foreach ($this->str->getterminateletter() as $row ) {
                        $no++;
                        ?>
                        <tr role="row" class="odd">
                              ...
                              <td>
                                    <a class="btn btn-sm btn-danger" href="<?php echo base_url('Structure/Delete_tletter/' . $row->id) ?>"onclick="return confirm('Are you sure To Delete this info ??')"><i class="fa fa-trash"></i> Delete </a>
                                    <a class="btn btn-sm btn-success" href="<?php echo base_url('Structure/showtletter/'.$row->id)?>"><i class="fa fa-windows">show</i></a>
                              </td>
                        </tr>
