<div class="content-wrapper">
      ...
      <div class="box-header">
            <h3 class="box-title"><b>WoredaNet Request Letter from OSTICA to Ethio-telecom </b></h3>
      </div>
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form role="form" action="<?php echo base_url('Structure/save_osticaletters'); ?>" method="post">
                                    <div class="box-body">
                                          ...
                                          <label for="exampleInputPassword1">Band Width </label>
                                                ...
                                                <option value="100mb">100mb</option>
                                                      ...
                                                      <input type="text" name="ipid" placeholder="-- Enter IP ID" class="form-control">
...
<div class="box-body">
      <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            ...
            <tbody>
                  ...
                  foreach ($this->str->getnewletters() as $row ) {
                        $no++;
                        ?>
                        <tr role="row" class="odd">
                              ...
                              <td>
                                    <a class="btn btn-sm btn-danger" href="<?php echo base_url('Structure/Delete_letter/' . $row->id) ?>"onclick="return confirm('Are you sure To Delete this info ??')"><i class="fa fa-trash"></i> Delete </a>
                                    <a class="btn btn-sm btn-success" href="<?php echo base_url('Structure/showletter/'.$row->id)?>"><i class="fa fa-windows">show</i></a>
                              </td>
                        </tr>
