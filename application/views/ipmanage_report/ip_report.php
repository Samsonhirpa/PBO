        ...
        <div class="col-xs-12">
          <div class="box box-default">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><img style="height: 120px;" src="<?php echo base_url();?>dist/img/oromia women.png" class="img-circle" alt="User Image"><b><i>OSTICA Ip Managements<b>New Request for WoredaNet Service Report</b></i></b><img style="height: 120px;" src="<?php echo base_url();?>dist/img/minster of women.png" class="img-circle" alt="User Image"></li>
            </ul>
            </div>
            <div class="box-body">
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-default">
                Zone Report <br><br>Plse <br><i>Click to Show</i> 
              </button>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-info">
                Woreda Report <br> <br>Plse <br><i>Click to Show</i>
              </button>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-danger">
                Kebele Report <br> <br>Plse <br><i>Click to Show</i>
              </button>
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-warning">
                Full Report <br> <br>Plse <br><i>Click to Show</i>
              </button>
              ...
              <div class="modal-body">
                                    <div class="row" style="background-color: whitesmoke">
                                          <div class="col col-md-12">
                                                <form action="<?php echo base_url('Report/zone_report') ?>" method="get"> 
                                                      <div class="box-body">
