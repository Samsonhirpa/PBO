...
<div class="box">
  <div class="row">
            ...
            <h3 class="box-title"><b>Total Children</b></h3>
      </div>
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Add Total Children</h4>
                        </div>
                        <div class="modal-body">
                              <form role="form" action="<?php echo base_url('Structure/Save_children'); ?>" method="post">
                                    <div class="box-body">
                        ...
                        <input type="date" placeholder="-- Enter Date --" name="date" class="form-control"> 
                                          ...
                                          <input name="female" class="form-control"  value="0" type="text" required>
                                                      <label for="exampleInputPassword1">Total Children</label>
                                                      <input type="text" name="totchildren" value="0" class="form-control">
...
<!-- /.box-header -->
 ...
 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 110.733px;" aria-label="Browser: activate to sort column ascending">Total Children</th>
...
<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 120.417px;" aria-label="CSS grade: activate to sort column ascending">Action</th></tr>
                ...
                <tbody>
                  <?php 
                  $no=0;
                  foreach ($this->str->getchildren() as $row ) {
                    $no++;
                  ?>
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $row->totchildren;?></td>
                  ...
                  <td>
                    ...
                    <a class="btn  btn-xs btn-danger" href="<?php echo base_url('Structure/Delete_children/' . $row->id) ?>"onclick="return confirm('Are you sure To Delete this info ??')"><i class="fa fa-trash">Delete</i></a>
          ...
          <div class="modal fade" id="modal-defaultedit<?php echo $row->id ?>">
                        <div class="modal-dialog">
                              <div class="modal-content">
                                    <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                          <h4 class="modal-title">Edit Total Children</h4>
                                    </div>
                                    <div class="modal-body">
                                          <form role="form" action="<?php echo base_url('Structure/Edit_children/'.$row->id); ?>" method="post">
                                                <div class="box-body">
                ...
                <input name="female" class="form-control"  value="<?php echo $row->female;?>" type="text" required class="form-control">
                     ...
                     <input type="text" name="totchildren" value="<?php echo $row->totchildren;?>" class="form-control" required>
    ...
    $(document).ready(function(e)
{
  $("input").change(function()
  {
    ...
    $("input[name=totchildren]").val(total);
  })
}
      )
  </script>
