<div class="content-wrapper">
      ...
      <button type="button"  data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-plus-square btn btn-primary">Add Terminate Service</i>
      </button>
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Add WoredaNet Service Terminate Form</h4>
                        </div>
                        <div class="modal-body">
                              <form role="form" action="<?php echo base_url('Structure/save_terminate'); ?>" method="post">
                                    <div class="box-body">
...
<div class="box-body">
      <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            ...
            <tbody>
                  ...
                  foreach ($this->str->getterminate($this->session->userdata('username')) as $row ) {
                        $no++;
                        ?>
