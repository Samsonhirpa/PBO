...
<div class="box">
  <div class="row">
            ...
            <h3 class="box-title"><b>Number of Children Whose Received Care and Support Services in Institution </b></h3>
      </div>
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Add Child Friendly</h4>
                        </div>
                        <div class="modal-body">
                              <form role="form" action="<?php echo base_url('Structure/Save_careandsupport'); ?>" method="post">
                                    <div class="box-body">
            ...
            <div class="box-body">
              <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                  <?php 
                  $no=0;
                  foreach ($this->str->getcareandsupport() as $row ) {
                    $no++;
                  ?>
                <tr role="row" class="odd">
                  ...
                  <td>
                   ...
                   <a class="btn btn-sm btn-danger" href="<?php echo base_url('Structure/delete_careandsupport/'.$row->id)?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash">delete</i></a>
                  ...
                  <div class="modal fade" id="modal-defaultedit<?php echo $row->id ?>">
                        <div class="modal-dialog">
                              <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                          <form role="form" action="<?php echo base_url('Structure/Edit_careandsupport/'.$row->id); ?>" method="post">
                                                <div class="box-body">
