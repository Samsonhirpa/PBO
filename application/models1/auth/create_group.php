...
<section class="content" style="min-height: 526px;">
        <div class="col-xs-12">
  <div class="col-lg-12 col-sm-12 col-xs-12 no-padding"><h1 class="box-title" style="font-family: Times New Roman, Times, serif; font-size: 30px;"><i class="fa fa-plus"></i> <?php echo lang('create_group_heading');?></h1></div>
</div>
